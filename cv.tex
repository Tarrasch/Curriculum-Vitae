...
\section{EDUCATION}
 \begin{itemize} % \itemsep -2pt  % reduce space between items
   \item Studying toward my Master's degree in Computer Science at Chalmers
     University of Technology. I expect to graduate either this year or mid
     2014.
   \item Exchange student at Georgia Tech Fall 2012 and Spring 2013.
   \item Bachelors degree in CSE from Chalmers University of Technology
     (2009-2012).
 \end{itemize}

\section{WORKING EXPERIENCE}
\emph{Facebook, Software Engineer Intern, May 2013-(Ongoing)}, Menlo Park, California
\vspace{0.2in}
   \begin{itemize} % \itemsep -2pt  % reduce space between items
   \item I'm working on an internal job scheduler. The scheduler uses reactive
     programming to work in environments where hosts and table region mappings
     are dynamic. Currently I'm replacing a hadoop job with a job using the
     internal scheduler.
 \end{itemize}
