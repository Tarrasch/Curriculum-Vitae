...
\section{EDUCATION}
 \begin{itemize} % \itemsep -2pt  % reduce space between items
   \item Presently I'm on an exchange program at Georgia Tech. I'm enrolled
     in the Computer Science and Engineering masters program at Chalmers University.
   \item I have a bachelors degree in CSE from Chalmers University (2009-2012).
 \end{itemize}
